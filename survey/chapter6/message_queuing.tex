...
\begin{tikzpicture}
    \lr{
        \umlclass[y=-2]{Thread}{
            ...
            \umlclass[x=5, y=-4]{Mutex}{
                \lr{}
            }{
                \lr{lock()}\\
                \lr{release()}
    }    
    \umlunicompo[attr2=myQ|1]{Thread}{Queue}
    \umluniassoc[attr2=*|targetQ, pos=0.8]{Thread}{Mutex}
    \umlcompo[mult1=1, mult2=1]{Queue}{Mutex}
}
\end{tikzpicture}
\caption{دیاگرام کلاس \lr{Message Queuing}}
