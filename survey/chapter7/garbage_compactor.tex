...
\begin{tikzpicture}
    \lr{  
        ...
        \begin{umlpackage}[x=5, y=-10]{MemoryManagmentSystem}
                ...
                \umluniassoc[mult1=1, attr2=FromList|1, anchor1=140, anchor2=-146]{GarbegeCollector}{FreeBlockList}
                \umluniassoc[mult1=1, attr2=1|ToList, anchor1=45, anchor2=-40]{GarbegeCollector}{FreeBlockList}
